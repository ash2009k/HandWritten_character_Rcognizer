...
def closewindows():
	...
	if k & 0xFF == ord('s'):
		...
		cv2.imwrite('C:/Users/Ashwini/PycharmProjects/deep/guihcr/result/'+comment+'_thres'+'.jpg',final_thr)
		cv2.imwrite('C:/Users/Ashwini/PycharmProjects/deep/guihcr/result/'+comment+'_src'+'.jpg',src_img)
		cv2.imwrite('C:/Users/Ashwini/PycharmProjects/deep/guihcr/result/'+comment+'_contr'+'.jpg',final_contr)
		print("Completed")
	elif k & 0xFF == int(27):
...
def letter_seg(lines_img, x_lines, i):
	...
	print(len(lines_img[0]),x_lines,len(contours))
	...
	for e in range(len(letter)):
		if(letter[e][0]<x_linescopy[0]):
			...
			letter_img = cv2.resize(letter_img_tmp, dsize =(60, 60), interpolation = cv2.INTER_AREA)
			cv2.imwrite('C:/Users/Ashwini/PycharmProjects/deep/guihcr/segmented_image/'+str(i+1)+'_'+str(word)+'_'+str(letter_index)+'.png', 255-letter_img)
		else:
			x_linescopy.pop(0)
			word += 1
			letter_index = 1
			...
			letter_img = cv2.resize(letter_img_tmp, dsize =(60, 60), interpolation = cv2.INTER_AREA)
			cv2.imwrite('C:/Users/Ashwini/PycharmProjects/deep/guihcr/segmented_image/'+str(i+1)+'_'+str(word)+'_'+str(letter_index)+'.png', 255-letter_img)
			print(letter[e][0],x_linescopy[0], word,e)
...
print("\n........Program Initiated.......\n")
src_img= cv2.imread('C:/Users/Ashwini/Desktop/doc/123.jpg', 1)
copy = src_img.copy()
